...
plt.scatter(points[:,0],points[:,1],s=100,color='red')
plt.show()
...
class K_Means:
    ...
    def fit(self,data):
		...
		print self.centroids[classification]
            ...
            for c in self.centroids:
                ...
                if np.sum((current_centroid-original_centroid)/original_centroid*100.0) > self.tol:
                    print("umm",np.sum((current_centroid-original_centroid)/original_centroid*100.0))
                    optimized = False
